# AutoPriseAi: Project Directory Structure

This document provides a comprehensive overview of the AutoPriseAi codebase structure, optimized for both human developers and AI models.

## Project Overview
AutoPriseAi is a local-first AI automation platform for Windows, integrating Gemini AI with local tools (skills), a React dashboard, and various communication interfaces.
...
│   │   └── logo.png
│   ├── Updates
│   │   ├── AutoPriseAi_v11_Implementation_Plan_FINAL.md
│   │   ├── AutoPriseAi_v12_Implementation_Plan_FINAL_v2.md
│   │   ├── V10_FEATURES.md
│   │   ├── AutoPriseAi_v12.1_Implementation_Plan_FINAL_v2.md
│   │   ├── AutoPriseAi_v12.1_Protection_Patch.md
│   │   ├── AutoPriseAi_Logging_Patch.md
│   │   └── AutoPriseAi_LinkedIn_Local_Plan.md
│   ├── ARCHITECTURE.md
│   ├── DIR_STRUCTURE.md
│   ├── SETUP_GUIDE.md
│   ├── USER_GUIDE.md
