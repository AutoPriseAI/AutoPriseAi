# AutoPriseAi — LinkedIn Automation Plan (Local Machine)
...
AutoPriseAi and LinkedIn are both on the same local Windows machine.
...
written by AutoPriseAi instead of the hardcoded string:
...
def play_recording(steps_file, content_file):
    # Read content written by AutoPriseAi
...
if __name__ == "__main__":
    ...
    # Accept --content-file override from AutoPriseAi
...
Create this agent in your AutoPriseAi Enterprise org.
...
- Tuesday: AutoPriseAi feature spotlight with concrete use case
- Wednesday: MSP pain point + how AutoPriseAi solves it
...
8. Add `LINKEDIN_SCRIPT_DIR=C:\LinkedInBot` to AutoPriseAi `.env`
...
12. In AutoPriseAi chat: `use linkedin_post skill with dry_run: true, content: "test"`
...
15. In AutoPriseAi chat: `use linkedin_post to post: "Testing my new AI automation setup. More updates soon. #AI #Automation"`
...
18. Add Jordan to AutoPriseAi Enterprise org with above settings
