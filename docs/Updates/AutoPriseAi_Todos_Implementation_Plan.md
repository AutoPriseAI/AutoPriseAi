# AutoPriseAi — Todos Feature Implementation Plan
...
If AutoPriseAi was offline when a recurring todo should have fired (e.g. reboot at 9am, daily todo fires at midnight):
...
*AutoPriseAi v13.0.0 — Todos Feature Implementation Plan*
