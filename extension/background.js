/**
 * AutoPriseAi Browser Relay — Background Service Worker (MV3)
 *
 * Maintains a WebSocket connection to the AutoPriseAi backend relay server.
...
function connect() {
  ...
  ws.onopen = () => {
    console.log('[Relay] Connected to AutoPriseAi backend');
    connected = true;
