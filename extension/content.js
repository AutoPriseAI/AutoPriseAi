/**
 * AutoPriseAi Browser Relay — Content Script
 *
...
(() => {
  ...
  if (window.__AutoPriseAiRelay) return;
  window.__AutoPriseAiRelay = true;

  // ─── Visual Indicator ───────────────────────────────────────────
  const indicator = document.createElement('div');
  indicator.id = 'AutoPriseAi-indicator';
  ...
  `;
  indicator.textContent = 'AutoPriseAi Relay';
