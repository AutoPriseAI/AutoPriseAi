...
const App: React.FC = () => {
  const [messages, setMessages] = useState<Message[]>([
    { id: '1', text: 'Welcome back. AutoPriseAi v12.6 is online and ready.', sender: 'bot', timestamp: new Date() }
  ]);
  ...
  useEffect(() => {
    ...
    newSocket.on('connect', () => {
      setConnected(true);
      addToast('Connected to AutoPriseAi', 'success');
    });
    ...
    <div className="dashboard-container">
      ...
      <aside className={`sidebar ${sidebarCollapsed ? 'sidebar--collapsed' : ''}`}>
        <div className="sidebar-brand">
          ...
          {!sidebarCollapsed && <h1>AutoPriseAi</h1>}
        </div>
            ...
            {activeTab === 'activity' && (
              ...
              >
                ...
                <p style={{ color: 'var(--text-dim)', fontSize: '0.85rem', marginTop: '8px' }}>
                  Real-time events from all AutoPriseAi subsystems
                </p>
