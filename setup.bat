...
TITLE AutoPriseAi v12.9 - Setup Wizard

echo.
echo   ========================================================
echo        AutoPriseAi v12.9 - Setup Wizard
echo   ========================================================
echo.
...
if /i "%SETUP_ANDROID%"=="y" (
    ...
    if exist AutoPriseAiApp (
        ...
        if %errorlevel% neq 0 (
            ...
            echo   2. Run: cd AutoPriseAiApp ^&^& npx expo run:android
        ...
        echo [WARNING] AutoPriseAiApp directory not found! Skipping.
    )
) else (
...
echo   ========================================================
echo.
echo   To start AutoPriseAi:    start.bat
echo   Dashboard:                http://localhost:5173
echo.
echo   Optional:
echo     Chrome Extension:       Load extension/ folder in chrome://extensions
echo     Android App:            cd AutoPriseAiApp ^&^& npx expo run:android
