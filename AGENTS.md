# AutoPriseAi — Agent Instructions

Welcome, Agent. You are operating within the AutoPriseAi codebase — a local-first AI automation platform for Windows built on Google Gemini, Express, Socket.io, and React.
...
Android App (AutoPriseAiApp) ──Socket.io over Cloudflare Tunnel──→ Express Server
