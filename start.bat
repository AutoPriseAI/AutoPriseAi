@echo off
TITLE AutoPriseAi v12.9

echo.
echo   ========================================================
echo        AutoPriseAi v12.9 - Starting System
echo   ========================================================
echo.
...
start "AutoPriseAi Backend" cmd /c "npm run dev"
...
start "AutoPriseAi Dashboard" cmd /c "npm run dashboard"
